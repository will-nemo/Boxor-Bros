...
<!DOCTYPE html>
<html>
<title>Submit a Custom Fabric!</title>
...
<!-- THIS IS THE CODE THAT CHANGES FOR EACH PAGE-->
 ...
 <div class="w3-display-container w3-margin" style="text-align:center">
    ...
    <h1 class="w3-middle" style="text-align:center">Submit a Custom Fabric To Buy From Our Store!!</h1>
...
<button type="submit" name="custom" class="w3-button w3-block w3-section w3-blue w3-ripple w3-padding">submit</button>
