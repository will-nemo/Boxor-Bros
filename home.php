     ...
     $mysqlqq = "SELECT * FROM users";
        ...
        if($flag == 0){
           ...
           echo' <form action="create.php">
            <button href="javascript:void(0)" class="w3-bar-item w3-button w3-hover-white w3-right" style="font-size:10px; margin-top:30px;">Create Product</button>  
            </form>';   
        }
  ...
  if (isset($_GET['delete'])) {
    ...
    if($Recordsf->num_rows > 0){ 
     ...
     ?>  
                    ...
                    <a href="home.php?delete=1">&times; </a>
                    </span>
     ...
     ?>  
                    <span onclick="this.parentElement.style.display='none'" class="w3-button w3-transparent w3-display-right">
                    <a href="home.php?delete=2">&times; </a>
                    </span>
     ...
     ?>  
                          ...
                          <span onclick="this.parentElement.style.display='none'" class="w3-button w3-transparent w3-display-right">
                              <a href="home.php?delete=3">&times; </a>
                            </span>            
     ...
     ?>  
                   <span onclick="this.parentElement.style.display='none'" class="w3-button w3-transparent w3-display-right">
                    <a href="home.php?delete=4">&times; </a>
                    </span>
...
function myAccFunc() {
  ...
  <div class="w3-display-container w3-text-white w3-hover-opacity w3-margin" style="text-align:center">
      <a href="boxer_display.php">
    <img src="fullsizeoutput_191.jpeg" border="0" alt="mountains" style="width:100%; padding-top: 25px;padding-left: 25px;padding-right: 25px; ">
            </a>
    <div class="w3-display-bottomleft w3-container" style="font-size:48px; padding-left: 40px;"><p>Casual, Custom, Comfortable</p></div>
  </div>
  ...
  <div class="w3-row-padding w3-margin">
    <div class="w3-third w3-round w3-display-container w3-text-white w3-hover-opacity" >
    <a href="item_display.php?varname=Pink/Blue%20Floral">
        <img class="w3-round-large" src="IMG_7221.JPG" style="
    position: relative;
    float: left;
    width:  400px;
    height: 400px;
    background-position: 50% 50%; margin-left: 20px; ">
        </a>
        <div class="w3-display-bottomleft w3-container" style="font-size:24px; padding-left: 40px;"><p>Featured Boxer of the Week</p></div>
    </div>
    <div class="w3-third w3-display-container w3-text-white w3-hover-opacity ">
      <a href="item_display.php?varname=Tropical%20Print">
      <img  class="w3-round-large" src="Orig_0327105.jpg" style="
     position: relative;
    float: left;
    width:  400px;
    height: 400px;
    background-position: 50% 50%;">
      ...
      <div class="w3-display-bottomleft w3-container" style="font-size:24px"><p>Custom Fabric of the Week</p></div>
    </div>
    <div class="w3-third w3-round w3-display-container w3-text-white w3-hover-opacity ">
         <a href="submit_custom.php">
      <img class="w3-round-large" src="IMG_0202.JPG" style="  position: relative;
    float: left;
    width:  400px;
    height: 400px;
    background-position: 50% 50%;">
        </a>
      <div class="w3-display-bottomleft w3-container" style="font-size:24px;"><p>Create Your Own Custom Boxer</p></div>
    </div>
  </div>
