...
<!-- THIS IS THE CODE THAT CHANGES FOR EACH PAGE-->
 ...
 <div class="w3-display-container w3-margin" style="text-align:center">
    <img src="IMG_0208.PNG" border="0" alt="logo" style="width:20%; height:20%; padding-top: 25px;padding-left: 25px;padding-right: 25px; ">
  </div> 
    
    
<form action="login.php" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
...
<button name="login" class="w3-button w3-block w3-section w3-blue w3-ripple w3-padding">Log In</button>

</form>
    
<form action="register.php" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
