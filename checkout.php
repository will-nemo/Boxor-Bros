...
<!-- THIS IS THE CODE THAT CHANGES FOR EACH PAGE-->
    ...
    <img src="IMG_0208.PNG" border="0" alt="logo" style="width:15%; height:15%; padding-top: 25px;padding-left: 25px;padding-right: 25px; ">
     ...
     <div class="w3-display-container w3-margin" style="">
        <h1 style="padding-left:100px; font-size:32px;">Checkout</h1>
    </div> 
   ...
   if ($conn->connect_error){
    ...
    <div class="w3-row w3-section w3-margin">
        <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-send-o"></i></div>
            <div class="w3-rest">
            <input class="w3-input w3-border" name="ship" type="text" placeholder="Shipping Address">
            </div>
    </div>

<div class="w3-row w3-section w3-margin" style="padding-left:60px;">
            <div class="w3-rest">
            <form action="processed.php">
            <button class="w3-margin w3-block w3-btn w3-blue w3-round-xxlarge" style="width:90%; ">Checkout</button>
            </form>
            </div>
    </div>
